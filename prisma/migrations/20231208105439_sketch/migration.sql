...
CREATE TABLE [dbo].[Canto] (
    ...
    [refTesto] NVARCHAR(1000),
    [refSpartito] NVARCHAR(1000),
    [refAccordi] NVARCHAR(1000),
...
-- AddForeignKey
ALTER TABLE [dbo].[Registrazione] ADD CONSTRAINT [Registrazione__canto_id_fkey] FOREIGN KEY ([_canto_id]) REFERENCES [dbo].[Canto]([id]) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[Registrazione] ADD CONSTRAINT [Registrazione__evento_id_fkey] FOREIGN KEY ([_evento_id]) REFERENCES [dbo].[Evento]([id]) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[Registrazione] ADD CONSTRAINT [Registrazione__gesto_id_fkey] FOREIGN KEY ([_gesto_id]) REFERENCES [dbo].[Gesto]([id]) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[Registrazione] ADD CONSTRAINT [Registrazione__momento_id_fkey] FOREIGN KEY ([_momento_id]) REFERENCES [dbo].[Momento]([id]) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[_AutoreToCanto] ADD CONSTRAINT [_AutoreToCanto_A_fkey] FOREIGN KEY ([A]) REFERENCES [dbo].[Autore]([id]) ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[_AutoreToCanto] ADD CONSTRAINT [_AutoreToCanto_B_fkey] FOREIGN KEY ([B]) REFERENCES [dbo].[Canto]([id]) ON DELETE CASCADE ON UPDATE CASCADE;
